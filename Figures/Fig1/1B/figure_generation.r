...
profile_scaled <- calculate_scaled_data("input1.csv", "input2.csv", "LENGTHS.csv", 74.14, 60.14)
...
profile_unscaled <- calculate_unscaled_data("input1.csv", "input2.csv", "LENGTHS.csv", 74.14, 60.14)
sink("stats.txt")
