setwd("/home/shriyas/cifs-lab/RIP_manuscript/Revised_Figures/Fig2/Fig2D")
...
a <- calculate_values("input_WT.csv","input_MET.csv",1,1,1)

d <- DMRs(a, 0.043, 30, 3)	#cutoff, distance, minimum number of bases
...
pdf("scaled_profile_043_30_3_FINAL.pdf", width=8, height=5)
...
reduced <- profile_scaled_2[seq(1, nrow(profile_scaled_2), 1),]	#keeps every N-th sequence	
png("scaled_heatmap_043_30_3_FINAL.png", width=ncol(reduced), height=nrow(reduced), units="px")	
#par(mar=c(0,0,0,0))
