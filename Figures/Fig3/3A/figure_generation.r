#load functions
setwd("/home/shriyas/cifs-lab/RIP_manuscript/Revised_Figures/Fig3/Fig3A/")
...
profile_scaled <- calculate_scaled_data("ago4_input1.csv", "ago4_input2.csv", "ago4_LENGTHS.csv", 20.57,15.86)
...
profile_unscaled <- calculate_unscaled_data("ago4_input1.csv", "ago4_input2.csv", "ago4_LENGTHS.csv", 20.57,15.86)
sink("Ago4_stats.txt")
